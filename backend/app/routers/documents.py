...
async def get_document_download_url(
    ...
    """
    Generate a short-lived signed URL (60 minutes) for downloading the original file.
...
async def get_document_view_url(
    ...
    """
    Generate a short-lived signed URL (60 minutes) for viewing the original file.

    Returns: { "url": "<signed_url>", "filename": "<original_filename>", "mime_type": "<mime>" }
    """
    org_id = get_user_org(auth_data)
